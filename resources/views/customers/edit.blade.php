...
<form action="/customers/{{$customer->id}}" class="form-group" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
            <div class="col-sm-10"><h1>Edit details for {{$customer->name}}</h1></div>
                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" id="home">
                        ...
                        <div class="row">
                                ...
                                <input type="text" name="name" class="col-lg-8 p-2 form-control" placeholder="Customer's Name" value="{{old('name') ?? $customer->name}}">
                                <input type="number" name="phone" class="col-lg-4 p-2 form-control" placeholder="Phone Number" value="{{old('phone') ?? $customer->phone}}">
                        </div>
                        <br>
                        <div class="row">
                                <input type="email" name="email" class="col-lg-6 p-2 form-control" placeholder="Email" value="{{old('email') ?? $customer->email}}">
                                <input type="text" name="contact" class="col-lg-6 p-2 form-control" placeholder="Address" value="{{old('contact') ?? $customer->contact}}">
                        </div>
                        <br>
                        <div class="row">
                            <div class="form-group col-lg-6">
                    ...
                    <br>
                            <button type="submit" class="btn btn-primary btn-block p-2">Edit Customer</button>
                        </form>
                    </div>
                  </div>
